...
def train(hyp, opt, device, tb_writer=None):
    ...
    ##transfer learing시 22,26,30을 제외한 나머지 layer는 freeze
    nofreeze = [f'model.{x}.' for x in [22, 26, 30]]  # parameter names to nofreeze (full or partial), 사용하고 있는 모델에서 detect 하는데 사용되는 layer만 nofreeze, 나머지 layer들은 freeze,현재 p5 기준
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sync-bn', action='store_true', help='use SyncBa  tchNorm, only available in DDP mode')
